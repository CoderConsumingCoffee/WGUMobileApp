...
public class CurrentNotesActivity extends AppCompatActivity {
    ...
    private String[] noteFieldInfo = new String[4];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new WGUAppDatabaseHelper(this);
        ...
        if (savedInstanceState == null) {
            ...
            fragmentTransaction.add(R.id.currentNotesFrame , new CurrentNotesFragment());
    ...
    public void loadNoteSelected(int position){
        LoadNoteForReviewAndUpdate loadNoteForReviewAndUpdate = new LoadNoteForReviewAndUpdate();
        loadNoteForReviewAndUpdate.execute(position);
    }


    private class LoadNoteForReviewAndUpdate extends AsyncTask< Integer, Void, Void> {
        ...
        protected void onPostExecute(Void result){
            ...
            FragmentManager fragmentManager = getFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.currentNotesFrame, addNoteFragment);
            fragmentTransaction.addToBackStack(null);
            fragmentTransaction.commit();
            addNoteFragment.updateFragmentFields(noteFieldInfo);
